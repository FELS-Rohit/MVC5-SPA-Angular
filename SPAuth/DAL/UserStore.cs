...
namespace MongoDB.AspNet.Identity
{
    ...
    public class UserStore<TUser> : UserStore<TUser, IdentityRole, string, IdentityUserLogin<string>, IdentityUserRole, IdentityUserClaim>, IUserStore<TUser>, IUserStore<TUser, string>, IDisposable
        ...
        where TUserClaim : IdentityUserClaim<TKey>, new()
    {
        ...
        public Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user)
        {
            ...
            return null; // Task.FromResult(user.Logins.ToList());
        }
